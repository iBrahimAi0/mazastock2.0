    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        <Routes>
          ...
          <Route
            path="/"
            element={!user ? <Navigate to="/login" /> : <TableauDeBord />}
          />
          ...
          <Route
            path="/produitsenstock"
            element={!user ? <Navigate to="/login" /> : <ProduitsEnStock />}
          />

          <Route
            path="/mouvementsstock"
            element={!user ? <Navigate to="/login" /> : <MouvementsStock />}
          />

          <Route
            path="/entrepots"
            element={!user ? <Navigate to="/login" /> : <Entrepots />}
          />

          <Route
            path="/ajustementsstock"
            element={!user ? <Navigate to="/login" /> : <AjustementsStock />}
          />

          <Route
            path="/gestionproduits"
            element={!user ? <Navigate to="/login" /> : <GestionProduits />}
          />

          <Route
            path="/commandeform"
            element={!user ? <Navigate to="/login" /> : <CommandeForm />}
          />

          <Route
            path="/listecommandes"
            element={!user ? <Navigate to="/login" /> : <CommandesList />}
          />

          <Route
            path="/gestionfournisseurs"
            element={!user ? <Navigate to="/login" /> : <GestionFournisseurs />}
          />

          <Route
            path="/gestionclients"
            element={!user ? <Navigate to="/login" /> : <GestionClients />}
          />

          <Route
            path="/gestioncategories"
            element={!user ? <Navigate to="/login" /> : <GestionCategories />}
          />

          <Route
            path="/gestioncaisses"
            element={!user ? <Navigate to="/login" /> : <GestionCaisses />}
          />

          <Route
            path="/lesventes"
            element={!user ? <Navigate to="/login" /> : <LesVentes />}
          />

          <Route
            path="/rapports"
            element={!user ? <Navigate to="/login" /> : <Rapports />}
          />
        </Routes>
      </main>
    </div>
